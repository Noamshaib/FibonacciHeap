...
//        testMeld();
    ...
    public static void testMeld() {
        ...
        if (onlyRoot1.marked != 0) {System.out.println("problem marked!!!");}
        ...
        if (onlyRoot2.marked != 0) {System.out.println("problem marked!!!");}
        if (FibonacciHeap.totalCuts() != 0 ) {System.out.println("problem cuts!!!");}
        if (FibonacciHeap.totalLinks() != 0 ) {System.out.println("problem links!!!");}
        ...
        if (only2roots.marked != 0) {System.out.println("problem marked!!!");}
        if (FibonacciHeap.totalCuts() != 0 ) {System.out.println("problem cuts!!!");}
        if (FibonacciHeap.totalLinks() != 0 ) {System.out.println("problem links!!!");}
        ...
        if (only3roots.marked != 0) {System.out.println("problem marked!!!");}
        if (FibonacciHeap.totalCuts() != 0 ) {System.out.println("problem cuts!!!");}
        if (FibonacciHeap.totalLinks() != 0 ) {System.out.println("problem links!!!");}
        ...
        if (heapFromListOfKeys.marked != 0) {System.out.println("problem marked!!!");}
        if (FibonacciHeap.totalCuts() != 0 ) {System.out.println("problem cuts!!!");}
        ...
        if (heapFromList3OfKeys.marked != 0) {System.out.println("problem marked!!!");}
        if (FibonacciHeap.totalCuts() != 0 ) {System.out.println("problem cuts!!!");}
        ...
        if (heapFromList2OfKeys.marked != 0) {System.out.println("problem marked!!!");}
        if (FibonacciHeap.totalCuts() != 0 ) {System.out.println("problem cuts!!!");}
    ...
    public static void testDelete(){
        ...
        FibonacciHeap.HeapNode x = minIsTheOldest.leftestRoot.getRight().getRight();
        ...
        if (minIsTheOldest.marked != 0) {System.out.println("problem marked!!!");}
        if (FibonacciHeap.totalCuts() != 0 ) {System.out.println("problem cuts!!!");}
        ...
        if (minIsTheOldest.min.getKey() != 5) {System.out.println("problem min!!!");}
        if (minIsTheOldest.marked != 1) {System.out.println("problem marked!!!");}
        ...
        x = misIsTheNewest.leftestRoot.getRight().getRight();
        ...
        if (misIsTheNewest.marked != 0) {System.out.println("problem marked!!!");}
        ...
        if (misIsTheNewest.min.getKey() != 10) {System.out.println("problem min!!!");}
        if (misIsTheNewest.marked != 1) {System.out.println("problem marked!!!");}
        ...
        x = misIsTheNewest.leftestRoot.getRight().getChild().getChild().getLeft();
        ...
        if (misIsTheNewest.min.getKey() != 10) {System.out.println("problem min!!!");}
        if (misIsTheNewest.marked != 2) {System.out.println("problem marked!!!");}
        ...
        if (x.getLeft().getKey() != 150 || x.getRight().getKey() != 150)
        ...
        if (misIsTheNewest.leftestRoot.getRight().getKey() != 100) {System.out.println("problem 100!!!");}
        if (misIsTheNewest.leftestRoot.getRight().getRight().getKey() != 170) {System.out.println("problem 170!!!");}
        if (misIsTheNewest.rightestRoot.getKey() != 10) {System.out.println("problem rightest!!!");}
    ...
    public static void testDecreaseKey(){
        ...
        y = y.getRight().getRight().getRight();
        ...
        y = misIsTheNewest.findMin().getChild().getChild().getChild().getRight();
    ...
    public static void testInsert() {
        ...
        insertionCheck.rightestRoot != null || insertionCheck.size() != 0 || insertionCheck.marked != 0 ||
        ...
        if (insertionCheck.findMin().getKey() != 100 || insertionCheck.leftestRoot.getKey() != 100 ||
                insertionCheck.rightestRoot.getKey() != 100 || insertionCheck.size() != 1 || insertionCheck.marked != 0 ||
        ...
        if (insertionCheck.findMin().getKey() != 50 || insertionCheck.leftestRoot.getKey() != 50 ||
                insertionCheck.rightestRoot.getKey() != 100 || insertionCheck.size() != 2 || insertionCheck.marked != 0 ||
        ...
        if (insertionCheck.findMin().getKey() != 50 || insertionCheck.leftestRoot.getKey() != 75 ||
                insertionCheck.rightestRoot.getKey() != 100 || insertionCheck.size() != 3 || insertionCheck.marked != 0 ||
        ...
        for (int i=0; i<insertionCheck.size(); i++) {
            ...
            System.out.print(next.getLeft().getKey());
            System.out.print(" key: ");
            System.out.print(next.getKey());
            System.out.print(" right: ");
            System.out.println(next.getRight().getKey());
    ...
    public static void testDeleteMin(){
        ...
        if (minIsTheOldest.findMin().getKey() != 1 || minIsTheOldest.leftestRoot.getKey() != 9 ||
                minIsTheOldest.rightestRoot.getKey() != 1 || minIsTheOldest.size() != 9 || minIsTheOldest.marked != 0 ||
        ...
        if (minIsTheOldest.findMin().getKey() != 2 || minIsTheOldest.leftestRoot.getKey() != 2 ||
                minIsTheOldest.rightestRoot.getKey() != 2 || minIsTheOldest.size() != 8 || minIsTheOldest.marked != 0 ||
        ...
        if (minIsTheOldest.findMin().getKey() != 3 || minIsTheOldest.leftestRoot.getKey() != 3 ||
                minIsTheOldest.rightestRoot.getKey() != 6 || minIsTheOldest.size() != 7 || minIsTheOldest.marked != 0 ||
        ...
        if (minIsTheOldest.findMin().getKey() != 4 || minIsTheOldest.leftestRoot.getKey() != 4 ||
                minIsTheOldest.rightestRoot.getKey() != 6 || minIsTheOldest.size() != 6 || minIsTheOldest.marked != 0 ||
        ...
        if (minIsTheOldest.findMin().getKey() != 5 || minIsTheOldest.leftestRoot.getKey() != 5 ||
                minIsTheOldest.rightestRoot.getKey() != 6 || minIsTheOldest.size() != 5 || minIsTheOldest.marked != 0 ||
                minIsTheOldest.numberOfTrees != 2 || FibonacciHeap.totalLinks() != 7 || FibonacciHeap.totalCuts() != 0 ||
                minIsTheOldest.isEmpty()){
        ...
        if (minIsTheOldest.findMin().getKey() != 6 || minIsTheOldest.leftestRoot.getKey() != 6 ||
                minIsTheOldest.rightestRoot.getKey() != 6 || minIsTheOldest.size() != 4 || minIsTheOldest.marked != 0 ||
                minIsTheOldest.numberOfTrees != 1 || FibonacciHeap.totalLinks() != 7 || FibonacciHeap.totalCuts() != 0 ||
                minIsTheOldest.isEmpty()){
        ...
        if (minIsTheOldest.findMin().getKey() != 7 || minIsTheOldest.leftestRoot.getKey() != 7 ||
                minIsTheOldest.rightestRoot.getKey() != 8 || minIsTheOldest.size() != 3 || minIsTheOldest.marked != 0 ||
                minIsTheOldest.numberOfTrees != 2 || FibonacciHeap.totalLinks() != 7 || FibonacciHeap.totalCuts() != 0 ||
                minIsTheOldest.isEmpty()){
        ...
        if (minIsTheOldest.findMin().getKey() != 8 || minIsTheOldest.leftestRoot.getKey() != 8 ||
                minIsTheOldest.rightestRoot.getKey() != 8 || minIsTheOldest.size() != 2 || minIsTheOldest.marked != 0 ||
                minIsTheOldest.numberOfTrees != 1 || FibonacciHeap.totalLinks() != 7 || FibonacciHeap.totalCuts() != 0 ||
                minIsTheOldest.isEmpty()){
        ...
        if (misIsTheNewest.findMin().getKey() != 1 || misIsTheNewest.leftestRoot.getKey() != 1 ||
                misIsTheNewest.rightestRoot.getKey() != 10 || misIsTheNewest.size() != 10 || misIsTheNewest.marked != 0 ||
        ...
        if (misIsTheNewest.findMin().getKey() != 2 || misIsTheNewest.leftestRoot.getKey() != 10 ||
                misIsTheNewest.rightestRoot.getKey() != 2 || misIsTheNewest.size() != 9 || misIsTheNewest.marked != 0 ||
        ...
        if (misIsTheNewest.findMin().getKey() != 3 || misIsTheNewest.leftestRoot.getKey() != 3 ||
                misIsTheNewest.rightestRoot.getKey() != 3 || misIsTheNewest.size() != 8 || misIsTheNewest.marked != 0 ||
        ...
        if (misIsTheNewest.findMin().getKey() != 4 || misIsTheNewest.leftestRoot.getKey() != 10 ||
                misIsTheNewest.rightestRoot.getKey() != 6 || misIsTheNewest.size() != 7 || misIsTheNewest.marked != 0 ||
        ...
        if (misIsTheNewest.findMin().getKey() != 5 || misIsTheNewest.leftestRoot.getKey() != 5 ||
                misIsTheNewest.rightestRoot.getKey() != 6 || misIsTheNewest.size() != 6 || misIsTheNewest.marked != 0 ||
        ...
        if (misIsTheNewest.findMin().getKey() != 6 || misIsTheNewest.leftestRoot.getKey() != 10 ||
                misIsTheNewest.rightestRoot.getKey() != 6 || misIsTheNewest.size() != 5 || misIsTheNewest.marked != 0 ||
                misIsTheNewest.numberOfTrees != 2 || FibonacciHeap.totalLinks() != 11+linkTillNow || FibonacciHeap.totalCuts() != 0 ||
                misIsTheNewest.isEmpty()){
            System.out.println("problem 6");
        }
        ...
        if (misIsTheNewest.findMin().getKey() != 7 || misIsTheNewest.leftestRoot.getKey() != 7 ||
                misIsTheNewest.rightestRoot.getKey() != 7 || misIsTheNewest.size() != 4 || misIsTheNewest.marked != 0 ||
        ...
        if (misIsTheNewest.findMin().getKey() != 8 || misIsTheNewest.leftestRoot.getKey() != 10 ||
                misIsTheNewest.rightestRoot.getKey() != 8 || misIsTheNewest.size() != 3 || misIsTheNewest.marked != 0 ||
        ...
        if (misIsTheNewest.findMin().getKey() != 9 || misIsTheNewest.leftestRoot.getKey() != 9 ||
                misIsTheNewest.rightestRoot.getKey() != 9 || misIsTheNewest.size() != 2 || misIsTheNewest.marked != 0 ||
        ...
        if (misIsTheNewest.findMin().getKey() != 10 || misIsTheNewest.leftestRoot.getKey() != 10 ||
                misIsTheNewest.rightestRoot.getKey() != 10 || misIsTheNewest.size() != 1 || misIsTheNewest.marked != 0 ||
                misIsTheNewest.numberOfTrees != 1 || FibonacciHeap.totalLinks() != 14+linkTillNow || FibonacciHeap.totalCuts() != 0 ||
                misIsTheNewest.isEmpty()){
        ...
        if (misIsTheNewest.findMin() != null || misIsTheNewest.leftestRoot != null ||
                misIsTheNewest.rightestRoot != null || misIsTheNewest.size() != 0 || misIsTheNewest.marked != 0 ||
        ...
        if (heapFromListOfKeys.findMin().getKey() != 1 || heapFromListOfKeys.leftestRoot.getKey() != 9 ||
                heapFromListOfKeys.rightestRoot.getKey() != 6 || heapFromListOfKeys.size() != 10 || heapFromListOfKeys.marked != 0 ||
        ...
        if (heapFromListOfKeys.findMin().getKey() != 2 || heapFromListOfKeys.leftestRoot.getKey() != 6 ||
                heapFromListOfKeys.rightestRoot.getKey() != 2 || heapFromListOfKeys.size() != 9 || heapFromListOfKeys.marked != 0 ||
        ...
        if (heapFromListOfKeys.findMin().getKey() != 3 || heapFromListOfKeys.leftestRoot.getKey() != 3 ||
                heapFromListOfKeys.rightestRoot.getKey() != 3 || heapFromListOfKeys.size() != 8 || heapFromListOfKeys.marked != 0 ||
        ...
        if (heapFromListOfKeys.findMin().getKey() != 4 || heapFromListOfKeys.leftestRoot.getKey() != 4 ||
                heapFromListOfKeys.rightestRoot.getKey() != 7 || heapFromListOfKeys.size() != 7 || heapFromListOfKeys.marked != 0 ||
        ...
        if (heapFromListOfKeys.findMin().getKey() != 5 || heapFromListOfKeys.leftestRoot.getKey() != 5 ||
                heapFromListOfKeys.rightestRoot.getKey() != 7 || heapFromListOfKeys.size() != 6 || heapFromListOfKeys.marked != 0 ||
        ...
        if (heapFromListOfKeys.findMin().getKey() != 6 || heapFromListOfKeys.leftestRoot.getKey() != 6 ||
                heapFromListOfKeys.rightestRoot.getKey() != 7 || heapFromListOfKeys.size() != 5 || heapFromListOfKeys.marked != 0 ||
                heapFromListOfKeys.numberOfTrees != 2 || FibonacciHeap.totalLinks() != linkTillNow+10 || FibonacciHeap.totalCuts() != 0 ||
                heapFromListOfKeys.isEmpty()){
            System.out.println("problem 6");
        }
        ...
        if (heapFromListOfKeys.findMin().getKey() != 7 || heapFromListOfKeys.leftestRoot.getKey() != 7 ||
                heapFromListOfKeys.rightestRoot.getKey() != 7 || heapFromListOfKeys.size() != 4 || heapFromListOfKeys.marked != 0 ||
                heapFromListOfKeys.numberOfTrees != 1 || FibonacciHeap.totalLinks() != linkTillNow+10 || FibonacciHeap.totalCuts() != 0 ||
                heapFromListOfKeys.isEmpty()){
            System.out.println("problem 7");
        }
        ...
        if (heapFromListOfKeys.findMin().getKey() != 8 || heapFromListOfKeys.leftestRoot.getKey() != 9 ||
                heapFromListOfKeys.rightestRoot.getKey() != 8 || heapFromListOfKeys.size() != 3 || heapFromListOfKeys.marked != 0 ||
                heapFromListOfKeys.numberOfTrees != 2 || FibonacciHeap.totalLinks() != linkTillNow+10 || FibonacciHeap.totalCuts() != 0 ||
                heapFromListOfKeys.isEmpty()){
            System.out.println("problem 8");
        }
        ...
        if (heapFromListOfKeys.findMin().getKey() != 9 || heapFromListOfKeys.leftestRoot.getKey() != 9 ||
                heapFromListOfKeys.rightestRoot.getKey() != 9 || heapFromListOfKeys.size() != 2 || heapFromListOfKeys.marked != 0 ||
        ...
        if (heapFromListOfKeys.findMin().getKey() != 10 || heapFromListOfKeys.leftestRoot.getKey() != 10 ||
                heapFromListOfKeys.rightestRoot.getKey() != 10 || heapFromListOfKeys.size() != 1 || heapFromListOfKeys.marked != 0 ||
                heapFromListOfKeys.numberOfTrees != 1 || FibonacciHeap.totalLinks() != linkTillNow+11 || FibonacciHeap.totalCuts() != 0 ||
                heapFromListOfKeys.isEmpty()){
            System.out.println("problem 10");
        }
        ...
        if (heapFromListOfKeys.findMin() != null || heapFromListOfKeys.leftestRoot != null ||
                heapFromListOfKeys.rightestRoot != null || heapFromListOfKeys.size() != 0 || heapFromListOfKeys.marked != 0 ||
    ...
    public static void testKmin(){
        System.out.println("k min numbers:");
        FibonacciHeap H = new FibonacciHeap();
        ...
        H.deleteMin();
        System.out.println(Arrays.toString(FibonacciHeap.kMin(H, 64)));
    }
}
